...
So I decided to code also a Navigation bar, a Tab bar, "Home" (with cards) and "Discovery" (with lists) view, a search button but also other buttons such as chevron see all, favourite, ellipsis, exc.
...
Then I made my slides using Keybote. Starting from feedbacks of the 1st challenge, I made this presentation more as a story, talking about what I learned from the 1st challenge and what i want to improve.
